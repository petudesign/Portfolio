...
Personal product design portfolio for Petteri Helttula.
...
- `index.html` - homepage and selected projects
- `about.html` - background, interests, and contact information
...
The site is currently in active portfolio-development mode. Case study content, images, videos, and project details are being refined iteratively.
